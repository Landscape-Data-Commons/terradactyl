...
In contrast to any hit data, the sum of first hit cover is always less than or equal to 100% when all cover types are included. Here only foliar cover is considered, excluding non-species codes (e.g., bare soil, litter), so rows do not sum to 100. 
