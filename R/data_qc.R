...
#' @param y Data frame. The data frame against which \code{x} will be checked. Must contain the variables specified in \code{joining_variables}. If \code{symmetric} is \code{TRUE} then this will also be checked against \code{x}.
